...
//   };
// };
// export const getGSTInvoiceFormat = async (): Promise<string> => {
//   try {
//     const formatDoc = await getDoc(doc(db, "settings", "gstInvoiceFormat"));
//     if (formatDoc.exists()) {
//       return formatDoc.data().format || "INV";
//     }
//     return "INV"; // default
//   } catch (error) {
//     console.error("Error fetching GST format:", error);
//     return "INV";
//   }
// };
// export const saveGSTInvoiceFormat = async (format: string): Promise<void> => {
//   try {
//     await setDoc(doc(db, "settings", "gstInvoiceFormat"), {
//       format: format.toUpperCase(),
//       updatedAt: new Date(),
//     });
//   } catch (error) {
//     console.error("Error saving GST format:", error);
//     throw error;
//   }
// };
// // Add Invoice
...
//       const gstInvoices = allInvoices.filter(inv => inv.invoiceType === "GST");
      
//       if (gstInvoices.length === 0) {
//         return `${format}00001`;
//       }
      
//       // Extract last number from format
//       const lastInvoice = gstInvoices[0].invoiceNumber;
//       const numberPart = lastInvoice.replace(/\D/g, "");
//       const nextNumber = parseInt(numberPart) + 1;
      
//       return `${format}${nextNumber.toString().padStart(5, "0")}`;
//     } else {
//       // Non-GST invoices use INV format
//       const nonGstInvoices = allInvoices.filter(inv => inv.invoiceType === "Non-GST");
      
//       if (nonGstInvoices.length === 0) {
//         return "INV00001";
//       }
      
//       const lastInvoice = nonGstInvoices[0].invoiceNumber;
//       const numberPart = lastInvoice.replace(/\D/g, "");
//       const nextNumber = parseInt(numberPart) + 1;
...
//     return invoiceType === "GST" ? "MAG00001" : "INV00001";
//   }
// };
